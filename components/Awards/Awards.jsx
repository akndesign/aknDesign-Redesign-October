...
function Awards(props) {
    ...
    const introWebPageData = {
        ...
        read: "Read",
        recentWorkRecentW: "RECENT WORK          RECENT WORK • RECENT WORK •",
...
return (
 ...
 <div className="awards-and-press">Awards and Press</div>
              <div className="itv-studios-how-to neuemontreal-medium-vermilion-63px">ITV Studios: How to Spend it Well</div>
              <div className="now-play-this-at-som neuemontreal-medium-vermilion-63px">Now Play This at Somerset House</div>
              <div className="london-design-festiv neuemontreal-medium-vermilion-63px">London Design Festival 2017</div>
              <div className="london-design-festiv-1 neuemontreal-medium-vermilion-63px">London Design Festival 2017</div>
